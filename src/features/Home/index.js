      ...
      <div className={classes.root}>
        <Switch>
          <Route
            ...
            path="/"
            component={() => (
              <Main onlineUsers={onlineUsers} onInvite={handleInviteUser} />
            )}
          />
          ...
          <Route
            exact
            path="/watching-history/:id"
            component={WatchingHistory}
          />
        </Switch>
        <ModalInviteJoinRoom
          open={openModalInvite}
          toggle={() => setOpenModalInvite(!openModalInvite)}
          onAccept={handleAcceptInvite}
          userInfo={userInfoInvite}
        />
        <ModalMatchMaking
          open={openModalMatchMaking}
          toggle={() => setOpenModalMatchMaking(!openModalMatchMaking)}
